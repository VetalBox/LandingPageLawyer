...
$_SESSION['urlpage']="<a href='tovar.php'>Главная</a> \ <a href='edit_administrators.php'>Изменение администратора</a>";
...
<p align="right"><input type="submit" name="submit_edit" id="submit_form" value="Сохранить" /></p>
